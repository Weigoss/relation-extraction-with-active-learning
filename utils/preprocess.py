...
def preprocess(cfg):
    ...
    if cfg.model_name == 'lm':
        ...
        train_data = [d  for d in train_data if 'head_idx' in d]
        valid_data = [d for d in valid_data if 'head_idx' in d]
        test_data = [d for d in test_data if 'head_idx' in d]
